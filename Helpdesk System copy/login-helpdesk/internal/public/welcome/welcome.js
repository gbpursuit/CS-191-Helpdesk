    ...
    try {
        ...
        loginForm.addEventListener('submit', async function(event) {
            ...
            if(!enteredUsername || !enteredPassword) {
                show_error(usernameError, "Enter username or password before submitting.z", 'password', 'username');
                return;
            }
...
function handle_new_account() {
    ...
    adminForm.addEventListener('submit', async function(event) {
        ...
        if(!enteredAdmin || !enteredPass) {
            show_error(adminError, "Enter username or password before submitting.", 'adminPassword', 'adminName');
            return;
        }
